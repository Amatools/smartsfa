...
class FirestoreDiscountPolicyRepository implements DiscountPolicyRepository {
  FirestoreDiscountPolicyRepository(this._firestore);

  final FirebaseFirestore _firestore;

  CollectionReference<Map<String, dynamic>> get _collection =>
      _firestore.collection('discount_policies');

  @override
  Stream<List<DiscountPolicy>> watchAll({required String tenantId}) {
    ...
    return _collection
      ...
      final items = snapshot.docs.map((doc) {
        ...
        return DiscountPolicy.fromMap(data);
      }).toList();
  ...
  @override
  Future<List<DiscountPolicy>> fetchAll({required String tenantId}) async {
    final normalizedTenantId = tenantId.trim();
    if (normalizedTenantId.isEmpty) {
      return const [];
    }
  ...
  @override
  Future<DiscountPolicy?> fetchById({
    ...
    data.putIfAbsent('id', () => doc.id);
    final entity = DiscountPolicy.fromMap(data);
  ...
  @override
  Future<void> save(DiscountPolicy entity) {
